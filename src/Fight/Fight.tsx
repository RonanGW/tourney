                    ...
                    trainers.push(
                        ...
                        <div className={' fightCard fightCard-left fightCard-right ' + loopActiveMonQueueState} style={{zIndex:"0",display: "flex", flexDirection: left ? "row" : "row-reverse"}} onClick={loopActiveMonOnClick}>
                            ...
                            <div id={loopTrainer.name.replace(/\s+/g, '')} className={'flexCol ' + loopActiveMonQueueState + (left ? " fightCard-right" : " fightCard-left")}>
                                <img style={{width:"160px",height:"160px",zIndex:"2",top:"37px",position:"relative"}} src={mImgURL}/>
                                <img style={{zIndex:"1",position:"relative",right:"10px"}} src={'./platforms/'+dex.mons[loopActiveMon.name + loopActiveMon.form].type1 + '.png'}/>
                                <div style={{zIndex:"2",position:"relative"}} className='stat-shorthand'>
                                    {"L"+loopActiveMon.lvl + ": "}
